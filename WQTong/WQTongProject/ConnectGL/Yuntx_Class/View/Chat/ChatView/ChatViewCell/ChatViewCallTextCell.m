...
-(void)bubbleViewTapGesture:(id)sender{
    ...
    [self dispatchCustomEventWithName:KResponderCustomChatViewCallTextCellBubbleViewEvent userInfo:@{KResponderCustomECMessageKey:self.displayMessage}];
...
-(void)layoutSubviews{
    ...
    NSMutableAttributedString * attributedString = [[NSMutableAttributedString alloc]
                                                    initWithString:body.callText];
    NSMutableParagraphStyle * paragraphStyle = [[NSMutableParagraphStyle alloc] init];
    [paragraphStyle setLineBreakMode:NSLineBreakByCharWrapping];
    [attributedString addAttribute:NSParagraphStyleAttributeName
                             value:paragraphStyle
                             range:NSMakeRange(0, [body.callText length])];
    [attributedString addAttribute:NSFontAttributeName value:LabelFont range:NSMakeRange(0, [body.callText length])];
